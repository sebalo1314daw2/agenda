...
RegisterForm.errMsg["name"] = "<span class='fastReading'>Nom:</span> Solament pot contenir lletres (no pot estar-hi buit  ni ser massa llarg).";
RegisterForm.errMsg["surnames"] = "<span class='fastReading'>Cognoms:</span> Solament pot contenir lletres (no pot estar-hi buit  ni ser massa llarg).";
RegisterForm.errMsg["password"] = new Array();
RegisterForm.errMsg["password"]["format"] = "<span class='fastReading'>Contrasenya:</span> De m&iacute;nim de 8 car&agrave;cters (no pot estar-hi buit  ni ser massa llarg).";
...
RegisterForm.errMsg["alias"]["format"] = "<span class='fastReading'>Alies:</span> Solament pot contenir car&agrave;cters alfanum&egrave;rics i alguns car&agrave;cters especials com el gui&oacute; baix, el gui&oacute; o el punt (no pot estar-hi buit  ni ser massa llarg).";
...
RegisterForm.errMsg["email"]["format"] = "<span class='fastReading'>Correu electr&ograve;nic:</span> No es correspon a cap correu v&agrave;lid (no pot estar-hi buit  ni ser massa llarg).";
